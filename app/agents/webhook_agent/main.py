...
builder.add_node("investigation_orchestrator", node_investigation_orchestrator)
...
builder.add_edge("get_customer_context", "investigation_orchestrator")
builder.add_edge("investigation_orchestrator", "draft_response")
